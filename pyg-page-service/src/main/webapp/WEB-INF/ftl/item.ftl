		...
		<div id="item">
			...
			<div class="product-info">
					...
					<div class="zoom">
                        ...
                        <#if (images?size >0 )>
                            <div id="preview" class="spec-preview">
                                <span class="jqzoom"><img jqimg="${images[0].url}" src="${images[0].url}" width="400px" height="400px" /></span>
                            </div>
                        </#if>
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="news"><span>${goodsDesc.caption!''}</span></div>
					<div class="summary">
						...
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${item}')?'selected':''}}"
                                       ng-click="selectedChange('${spec.attributeName}','${item}')">${item}
